...
// BCIController.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CBCIControllerApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CBCIControllerApp

CBCIControllerApp::CBCIControllerApp()
{
...
// Единственный объект CBCIControllerApp

CBCIControllerApp theApp;


// Инициализация CBCIControllerApp

BOOL CBCIControllerApp::InitInstance()
{
