...
3.  **Калибровка**
    *   Для начала попробуйте то что вызывает дисосанс: порно, гейпорно, медитация, тревога - это экстремальные образы на которые легче уловить паттерн. 
...
# Окончательная цель и будущее

Интерфейс мозг-компьютер беспроводной с двойным и полным дуплексом.

- Проецирование модулей управления прямо в мозг
- Управление исполнительными механизмами и устройствами мысленно

## Плюсы:
 - Всегда можно раздолбать узел управления, а не вырвать кусок мозга как в NeuroLink
## Минусы
 - Требует усилий, которые лингвистическое ядро Запада легко сводит на нет
