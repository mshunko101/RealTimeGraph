...
// RealTimeGraph.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CRealTimeGraphApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CRealTimeGraphApp

CRealTimeGraphApp::CRealTimeGraphApp()
{
...
// Единственный объект CRealTimeGraphApp

CRealTimeGraphApp theApp;


// Инициализация CRealTimeGraphApp

BOOL CRealTimeGraphApp::InitInstance()
{
